...
\titleformat{\chapter}[display]
    ...
    {}
    {0pt}
    {\large\bfseries\MakeUppercase{\thechapter}. }{}
...
\renewcommand{\cftchapfont}{\hspace{-0.28em}\normalsize\bfseries\MakeUppercase{\chaptername} }
\renewcommand{\cftsecfont}{\hspace{31pt}}
\renewcommand{\cftsubsecfont}{\hspace{4.35pt}}
\renewcommand{\cftbeforechapskip}{1em}
\renewcommand{\cftparskip}{1mm}
\renewcommand{\cftdotsep}{1}
\setcounter{tocdepth}{2} % задать глубину оглавления — до subsection включительно

%убираем из оглавления слово "Глава"
...
% ====================================================================
\begin{document}
%начинаем нумерацию не с 1 страницы
\setcounter{page}{2}
...
\includechapter{x1} % глава 1

\includechapter{x2} % глава 2

\includechapter{x3} % глава 3

\includechapter{x4} % глава 3
